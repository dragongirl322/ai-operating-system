# Sources
FAA: https://www.faa.gov/lessons_learned/transport_airplane/accidents/PH-BUF

Official Spanish report, part 1: https://web.archive.org/web/20200608015805/http://project-tenerife.com/nederlands/PDF/Spanish_report.PDF
...
Fantastic and informative Medium article *# Apocalypse on the Runway: Revisiting the Tenerife Airport Disaster* by Admiral Cloudbird: https://admiralcloudberg.medium.com/apocalypse-on-the-runway-revisiting-the-tenerife-airport-disaster-1c8148cb8c1b

Nova *The Final Eight Minutes*: https://www.pbs.org/wgbh/nova/planecrash/minutes.html
...
Unbeknownst to the crews and travelers, in Gran Canaria terrorist group had detonated a bomb in the airport (more details here). At x time, while both flights were in route, the crews of the Pan Am and KLM 747s received the unwelcome news that their destination airport was closed until further notice. All traffic, they were told, would be diverted to Los Rodeos Airport on the neighboring island of Tenerife. The pilot of the Pan American flight, Captain Victor Grubb, asked if they could continue to circle Gran Canaria until all clear given and was told they had to go land at Los Rodeos. 

Los Rodeos is a single runway, single parallel taxiway. No ground radar. Had to get ~50 planes out. 
...
All 248 on KLM fatal; 9 crew, 317 passengers PA fatal=total of 583 people
...
Jan Bartelski, a KLM captain until 1978 and later president of the [International Federation of Air Line Pilots' Associations](https://en.wikipedia.org/wiki/International_Federation_of_Air_Line_Pilots'_Associations "International Federation of Air Line Pilots' Associations"), was a contemporary of Veldhuyzen van Zanten and knew him personally. In his book _Disasters In The Air_, he describes Veldhuyzen van Zanten as: 
...
## Important details
According to an NBC news clip from March 28, Spanish officials were already blaming the pilot from KLM.[^2]
In December of 1976, the Dutch government created new duty time rules. Prior to this, captains had discretion for how to adjust duty time and it was relatively easy to adjust taking only a few factors into account. The new rules were absolutely rigid and making adjustments was so complex that management asked pilots to call for assistance. The KLM captain did this by radio. He was told if they were able to depart Gran Canaria by 1900 (check that) they would be fine. If they weren't able to depart by that time, they'd have to interrupt the flight which would have been problematic for the company and their passengers. It would also be difficult to find lodging for all passengers given the heavy tourist timing. All reports indicate this was a topic of discussion with the KLM crew, likely discovered from their flight recorders. It is important to note that penalties for not following these regulations are extreme; license revoked, found criminally liable 
...
When asked for ATC clearance, ATC responded: KLM 8705 [sic] uh [you are cleared](https://www.pbs.org/wgbh/nova/planecrash/minu-glossary.html#mg15) to the Papa beacon. Climb to and maintain flight level 90 ... right turn after takeoff proceed with heading 040 until intercepting the 325 radial from Las Palmas VOR.
...
Human factors involved 3 times that could have added to outcome:
1. When controller said "Okay" when KLM said "we're at takeoff" or "we're taking off"--then paused; Dutch crew maybe never heard 
2. When ATC asked PA to report when clear for first and only time ATC used "Papa Alpha" in call; Dutch Crew probably didn't register as being PA 1736.
3. KLM Flight eng "asking" if PA clear. Fog was thick so pilots and co-pilots focused on other things, flight eng likely more aware of radio transmissions; could have asserted himself.
